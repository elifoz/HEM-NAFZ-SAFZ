...
Params["max_date"] = "2023-08-28" # Maximum date for reporting the data
...
Params["min_latitude"] = "39" # Minimum latitude-North Anatolian
Params["max_latitude"] = "42" # Maximum latitude-North Anatolian

Params["min_longitude"] = "24" # Minimum longitude-North Anatolian
Params["max_longitude"] = "42" # Maximum longitude-North Anatolian
...
file_path = "datasets/NorthAnatolian-1923-2023/" + "NorthAnatolianFault" + "_raw" + ".csv"
...
for start_num in range(1923, 2024, 1):
    ...
    Params["min_latitude"] = "39" # Minimum latitude-North Anatolian
    Params["max_latitude"] = "42" # Maximum latitude-orth Anatolian
    ...
    file_path = "datasets/NorthAnatolian-1923-2023/" + "NorthAnatolianFault" + str(start_num) + "_1_newraw" + ".csv"
    df.to_csv(file_path)
    ...
    file_path = "datasets/NorthAnatolian-1923-2023/" + "NorthAnatolianFault" + str(start_num) + "_2_newraw" + ".csv"
    df.to_csv(file_path)
    ...
    file_path = "datasets/NorthAnatolian-1923-2023/" + "NorthAnatolianFault" + str(start_num) + "_3_newraw" + ".csv"
    df.to_csv(file_path)
    ...
    file_path = "datasets/NorthAnatolian-1923-2023/" + "NorthAnatolianFault" + str(start_num) + "_4_newraw" + ".csv"
