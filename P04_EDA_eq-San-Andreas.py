...
plt.title("Kuzey Anadolu Fay Hattı", fontdict=font1)
plt.ylabel("Büyüklük" , fontdict=font2)
plt.xlabel("Tarih", fontdict=font2)
plt.plot(df_eq_large["time"],df_eq_large["mag"],marker="o", color="green");
...
plt.xlabel("EQ magnitude", size = 13);
